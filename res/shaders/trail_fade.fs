// Draws faded source image with displacement.
// By using double-buffered rendering this effect can create a turbulent trail
// The noise function used in this shader was copied from https://stegu.github.io/webgl-noise/webdemo/
// Scroll to the bottom to see the main function.
...
void main() {
    ...
    vec3 noise_coord = vec3(vec2(uv.x * res.x / res.y, uv.y) * 10, time * 0.8);
